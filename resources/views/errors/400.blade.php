...
<section id="wrapper" class="error-page">
  <div class="error-box">
    <div class="error-body text-center">
      ...
      <a href="{{ url('/') }}" class="btn btn-danger btn-rounded waves-effect waves-light m-b-40">Kembali Beranda</a> </div>
...
<script src="{{ url('/') }}/ampleadmin/dist/js/bootstrap.min.js"></script>
