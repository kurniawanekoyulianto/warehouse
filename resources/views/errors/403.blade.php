...
<section id="wrapper" class="error-page">
  <div class="error-box">
    <div class="error-body text-center">
      ...
      <h3 class="text-uppercase">Forbidden Error, Anda tidak diperkenankan untuk mengakses server ini</h3>
      <a href="{{ url('/') }}" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Kembali Beranda</a> </div>
